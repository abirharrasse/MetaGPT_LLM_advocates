...
def get_multi_debate_scores(question: str, answer1: str, answer2: str, investment: float = 0.1, n_round: int = 3, n_advocates: int = 3) -> List[str]:
...
#     scores = get_debate_scores(question, answer1, answer2, investment=0.1, n_round=3, n_advocates=3)
#     print("Debate Scores:", scores)
